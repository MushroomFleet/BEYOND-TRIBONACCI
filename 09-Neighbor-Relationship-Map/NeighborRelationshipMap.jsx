...
// Permutation table seeded by input
...
// ─────────────────────────────────────────────────────────────────────────────────
// TRIBONACCI-STYLE WHITE NOISE (Simulates discontinuity)
// ─────────────────────────────────────────────────────────────────────────────────

const tribonacciNoise = (x, y, seed) => {
  // Simulates Tribonacci's lack of spatial coherence
  // Each cell's value is independent of neighbors
...
const calculateSimilarity = (value1, value2) => {
  // Returns 0-1 where 1 is identical, 0 is maximally different
...
const valueToColor = (value, mode = 'terrain') => {
  if (mode === 'terrain') {
    // Deep ocean to high mountain gradient
    if (value < 0.3) {
      const t = value / 0.3;
    ...
    // Similarity heatmap: red (different) to green (similar)
...
const similarityToGlow = (similarity) => {
  // Returns glow color based on similarity
...
export default function NeighborRelationshipMap() {
  // ─────────────────────────────────────────────────────────────────────────────
  // STATE
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  const [viewMode, setViewMode] = useState('comparison'); // 'comparison', 'coherent', 'tribonacci'
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // RELATIONSHIP DATA FOR SELECTED CELL
  // ─────────────────────────────────────────────────────────────────────────────
            ...
            <div style={controlStyle}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <input
                  ...
                  onChange={(e) => setNoiseScale(parseInt(e.target.value) / 100)}
                  style={sliderStyle}
                />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  ...
                  height: '12px',
                  borderRadius: '2px',
                  background: valueToColor(0.2, 'terrain'),
                }} />
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  ...
                  height: '12px',
                  borderRadius: '2px',
                  background: valueToColor(0.5, 'terrain'),
                }} />
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  ...
                  height: '12px',
                  borderRadius: '2px',
                  background: valueToColor(0.9, 'terrain'),
                }} />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  ...
                  boxShadow: '0 0 6px rgba(80, 255, 80, 0.8)',
                }} />
